...
It's also possible to specify multiple (sub)domains for a single update request,
by separating them with a comma. (This requires your dynDNS client to accept this
syntax.) For example, when using ddclient, you can edit ``ddclient.conf`` and set
