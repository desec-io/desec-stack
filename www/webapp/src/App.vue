<template>
  <v-app id="inspire">
    ...
    <v-app-bar color="white" :extended="authenticated">
      ...
      <v-btn class="mx-4" color="primary" variant="flat" :to="{name: 'signup', query: $route.query}" rel="nofollow" v-if="!authenticated">Create Account</v-btn>
      <v-btn class="mx-4 ml-0" color="primary" variant="flat" :to="{name: 'login'}" rel="nofollow" v-if="!authenticated">Log In</v-btn>
