...
apiurls = [
    ...
    url(r'^domains/(?P<name>[a-zA-Z\.\-_0-9]+)/rrsets/(?P<subname>[a-zA-Z\.\-_0-9]*)\.\.\./$', RRsetsDetailSpecific.as_view(), name='rrsets-subname'),
    url(r'^domains/(?P<name>[a-zA-Z\.\-_0-9]+)/rrsets/(?P<type>[A-Z]+)/$', RRsetsDetailSpecific.as_view(), name='rrsets-type'),
    url(r'^domains/(?P<name>[a-zA-Z\.\-_0-9]+)/rrsets/(?P<subname>[a-zA-Z\.\-_0-9]*)\.\.\./(?P<type>[A-Z]+)/$', RRsetDetail.as_view(), name='rrset'),
